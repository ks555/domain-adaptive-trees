"""
Functions and run procedures for the experiments
"""
...
def main():
    ...
    filename = "results/exp/results_{}_{}_{}_{}".format(from_pos, to_pos, att_string, maxdepth_td) + \
               (("_" + fairness_metric) if fairness_metric is not None else "") + ".pkl"
